...
public class MapView extends Container implements
	...
	public MapView() {
		...
		this.frameBuffer = new FrameBuffer(this.model.frameBufferModel,
				this.model.displayModel, GRAPHIC_FACTORY);
		this.frameBufferController = FrameBufferController.create(
				this.frameBuffer, this.model);
		...
		this.mapScaleBar = new DefaultMapScaleBar(this.model.mapViewPosition,
				this.model.mapViewDimension, GRAPHIC_FACTORY,
				this.model.displayModel);
	}
	...
	public BoundingBox getBoundingBox() {
		return MapPositionUtil.getBoundingBox(
				this.model.mapViewPosition.getMapPosition(), getDimension(),
	...
	public void paint(Graphics graphics) {
		...
		GraphicContext graphicContext = AwtGraphicFactory
	...
	public void addLayer(Layer _layer, BoundingBox _bbox) {
		getLayerManager().getLayers().add(_layer);

		setMapPosition(_bbox);
	}

	public void addLayer(Layer _layer) {
		getLayerManager().getLayers().add(_layer);
		getModel().mapViewPosition.setCenter(_layer.getPosition());
	}
